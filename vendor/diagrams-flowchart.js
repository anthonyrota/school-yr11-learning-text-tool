  ...
  \*********************************/
        ...
        function (module, exports, __webpack_require__) {
            ...
            (Symbol.prototype.getAttr = function (attName) {
                if (this.chart) {
                    var opt1,
                        opt3 = this.chart.options
                            ? this.chart.options[attName]
                            : void 0,
                        opt2 = this.chart.options.symbols
                            ? this.chart.options.symbols[this.symbolType][
                                  attName
                              ]
                            : void 0;
                    return (
                        this.chart.options.flowstate &&
                            ...
                            (opt1 = this.chart.options.flowstate[
                                this.flowstate
                            ][attName]),
                        opt1 || opt2 || opt3
                    );
                    ...
                    if (this.next) {
                        ...
                        if ('right' === this.next_direction) {
                            ...
                            this.next.isPositioned ||
                                (this.next.setY(
                                    rightPoint.y - this.next.height / 2,
                                ),
                                this.next.shiftX(
                                    this.group.getBBox().x +
                                        this.width +
                                        lineLength,
                                ),
                                (function shift() {
                                    for (
                                        ...
                                        var diff = Math.abs(
                                            symb.getCenter().x -
                                                self.next.getCenter().x,
                                        );
                                        if (
                                            symb.getCenter().y >
                                                self.next.getCenter().y &&
                            ...
                            this.next.isPositioned ||
                                (this.next.setY(
                                    leftPoint.y - this.next.height / 2,
                                ),
                                this.next.shiftX(
                                    -(
                                        this.group.getBBox().x +
                            ...
                            this.next.isPositioned ||
                                ...
                                this.next.setX(
                                    bottomPoint.x - this.next.width / 2,
                                ),
                                (this.next.isPositioned = !0),
                                this.next.render());
                        }
                ...
                (Symbol.prototype.drawLineTo = function (symbol, text, origin) {
                    this.connectedTo.indexOf(symbol) < 0 &&
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                ...
                                0 === symbol.rightLines.length &&
                                0 === this.leftLines.length
                                    ? (line = drawLine(
                                          this.chart,
                                          left,
                                          symbolRight,
                            ...
                            0 === symbol.leftLines.length &&
                            0 === this.rightLines.length
                                ? (line = drawLine(
                                      this.chart,
                                      right,
                                      symbolLeft,
                        ...
                        0 === symbol.topLines.length &&
                        0 === this.bottomLines.length
                            ? (line = drawLine(
                                  this.chart,
                                  bottom,
                                  symbolTop,
                    ...
                    if (
                        ...
                        for (
                            var l = 0, llen = this.chart.lines.length;
                            l < llen;
                            l++
                        )
                            for (
  ...
  \************************************/
        ...
        function (module, exports) {
            ...
            function drawLine(chart, from, to, text) {
                var i, len;
                '[object Array]' !== Object.prototype.toString.call(to) &&
                    (to = [to]);
                var path = 'M{0},{1}';
  ...
  \********************************/
        ...
        function (module, exports, __webpack_require__) {
                            ...
                            drawSVG: function (container, options) {
                                function getDisplaySymbol(s) {
                                    ...
                                    switch (s.symbolType) {
                                        ...
                                        case 'operation':
                                            dispSymbols[s.key] = new Operation(
                                                diagram,
                                                s,
                                            );
                                            break;
                                        ...
                                        case 'inputoutput':
                                            dispSymbols[
                                                s.key
                                            ] = new InputOutput(diagram, s);
                                            break;

                                        case 'subroutine':
                                            dispSymbols[s.key] = new Subroutine(
                                                diagram,
                                                s,
                                            );
                                            break;
                                        ...
                                        case 'condition':
                                            dispSymbols[s.key] = new Condition(
                                                diagram,
                                                s,
                                            );
                                            break;
                                        ...
                                        case 'parallel':
                                            dispSymbols[s.key] = new Parallel(
                                                diagram,
                                                s,
                                            );
                                            break;
                ...
                for (; lines.length > 0; ) {
                    ...
                    if (line.indexOf('=>') >= 0) {
                        ...
                        if (
                            ...
                            startIndex >= 0 &&
                                endIndex >= 0 &&
                                ((symbol.target = symbol.link.substring(
                                    startIndex,
                                    endIndex,
                                )),
                                (symbol.link = symbol.link.substring(
                                    0,
                                    startIndex - 1,
                                )));
                        }
            ...
            var FlowChart = __webpack_require__(/*! ./flowchart.chart */ 7),
                ...
                Condition = __webpack_require__(
                    /*! ./flowchart.symbol.condition */ 5,
                ),
                Parallel = __webpack_require__(
                    /*! ./flowchart.symbol.parallel */ 6,
                );
  ...
  \*******************************************/
        ...
        function (module, exports, __webpack_require__) {
            function Condition(chart, options) {
                ...
                (height += height / 2),
                    (height = Math.max(0.5 * width, height));
                var startX = width / 4,
                    startY = height / 4;
                this.text.attr({
            ...
            var Symbol = __webpack_require__(/*! ./flowchart.symbol */ 2),
                inherits = __webpack_require__(/*! ./flowchart.helpers */ 1)
                    .inherits,
            ...
            inherits(Condition, Symbol),
                (Condition.prototype.render = function () {
                    this.yes_direction &&
                        (this[
                            this.yes_direction + '_symbol'
                        ] = this.yes_symbol),
                        this.no_direction &&
                            (this[
                                this.no_direction + '_symbol'
                            ] = this.no_symbol);
                            ...
                            !(function shift() {
                                for (
                                    ...
                                    if (
                                        ...
                                        var diff = Math.abs(
                                            symb.getCenter().x -
                                                self.right_symbol.getCenter().x,
                                        );
                                        if (
                                            symb.getCenter().y >
                                                self.right_symbol.getCenter()
                                                    .y &&
                                ...
                                if (hasSymbolUnder) {
                                    if ('end' === self.right_symbol.symbolType)
                                        return;
                                    self.right_symbol.setX(
                                        symb.getX() + symb.width + lineLength,
                                    ),
                                        shift();
                                }
                            })(),
                    ...
                    if (this.left_symbol) {
                        ...
                        if (!this.left_symbol.isPositioned) {
                            this.left_symbol.setY(
                                leftPoint.y - this.left_symbol.height / 2,
                            ),
                            ...
                            !(function shift() {
                                for (
                                    ...
                                    if (
                                        ...
                                        var diff = Math.abs(
                                            symb.getCenter().x -
                                                self.left_symbol.getCenter().x,
                                        );
                                        if (
                                            symb.getCenter().y >
                                                self.left_symbol.getCenter()
                                                    .y &&
                                ...
                                if (hasSymbolUnder) {
                                    if ('end' === self.left_symbol.symbolType)
                                        return;
                                    self.left_symbol.setX(
                                        symb.getX() + symb.width + lineLength,
                                    ),
                                        shift();
                                }
            ...
            inherits(Parallel, Symbol),
                (Parallel.prototype.render = function () {
                    this.path1_direction &&
                        (this[
                            this.path1_direction + '_symbol'
                        ] = this.path1_symbol),
                        this.path2_direction &&
                            (this[
                                this.path2_direction + '_symbol'
                            ] = this.path2_symbol),
                        this.path3_direction &&
                            (this[
                                this.path3_direction + '_symbol'
                            ] = this.path3_symbol);
                    var lineLength = this.getAttr('line-length');
                    if (this.bottom_symbol) {
                        var bottomPoint = this.getBottom();
                    ...
                    if (this.top_symbol) {
                        ...
                        this.top_symbol.isPositioned ||
                            (this.top_symbol.shiftY(
                                this.getY() -
                                    this.top_symbol.height -
                                    lineLength,
                            ),
                            this.top_symbol.setX(
                                topPoint.x + this.top_symbol.width,
                            ),
  ...
  \********************************/
        ...
        function (module, exports, __webpack_require__) {
            ...
            var Raphael = __webpack_require__(/*! raphael */ 16),
                defaults = __webpack_require__(/*! ./flowchart.helpers */ 1)
                    .defaults,
                defaultOptions = __webpack_require__(
                    /*! ./flowchart.defaults */ 8,
                ),
                Condition = __webpack_require__(
                    /*! ./flowchart.symbol.condition */ 5,
                ),
                        ...
                        setFlowStateByParam: function (
                            ...
                            return this.each(function () {
                                ...
                                for (var property in chart.symbols)
                                    if (
                                        chart.symbols.hasOwnProperty(property)
                                    ) {
